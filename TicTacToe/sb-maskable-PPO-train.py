...
for nn in [
    ...
    for env in [
        ...
        MeanSpacedCounterGameEnvironment1,
        SampledSpacedCounterGameEnvironment1,
        MeanSpacedCounterGameEnvironment2,
        SampledSpacedCounterGameEnvironment2,
        MeanSpacedCounterGameEnvironment3,
        SampledSpacedCounterGameEnvironment3,
        MeanSpacedCounterGameEnvironment4,
        SampledSpacedCounterGameEnvironment4,
        MeanSpacedCounterGameEnvironment5,
        SampledSpacedCounterGameEnvironment5,
        MeanSpacedCounterGameEnvironment6,
        SampledSpacedCounterGameEnvironment6,
        MeanSpacedCounterGameEnvironment7,
        SampledSpacedCounterGameEnvironment7,
